...
private:
    ...
    int send_alert_to_base(int base_station_rank, char *alert_msg);
    ...
    bool prompt_or_not(EVNodeMessage* msg, int num_of_neighbor, int avail_neighbor[], int num_of_avail_neighbor);
